...
<!-- умеет передавать родителю информацию, о том -->
...
export default {
  ...
  methods: {
    ...
    // два следующих метода подтверждают (true) или отменяют (false) действие и передают родителю
    confirm() {
...
.popup {
  ...
  width: 250px;
  min-height: 100px;
  background-color: rgb(116, 146, 255);
  box-shadow: 0 0 16px 0 rgb(92, 128, 255);;
  top: 30vh;
